...
INSERT INTO `customer` (`id`, `username`, `password`, `fullname`, `email`, `created_at`, `status`) VALUES
...
INSERT INTO `product` (`id`, `name`, `description`, `sku`, `price`, `srp_price`, `qty`, `image`, `category_id`, `supplier_id`, `online`, `created_at`, `status`) VALUES
...
(50,	'Hand Bag',	'Made of Canvas,\r\nDesign: Stripes,\r\nSize: 14 x 12 inches,\r\nMade by: Students of CHMSC Talisay',	'106',	150,	100,	5,	'0e58df9da568e1ae84ec9e0be9b41b0d.JPG',	9,	2,	1,	'2017-01-22',	1),
(51,	'Pillow',	'Made of Micro Fiber,\r\nColor: Black and White,\r\nSize: 12x12 inches,\r\nMade by: TLE Students of CHMSC Talisay',	'108',	50,	40,	15,	'77e4c0fff7ce9e545cef4ced27f838c2.JPG',	9,	2,	1,	'2017-01-22',	1),
...
(53,	'Pillow',	'Made of Micro Fiber,\r\nColor: Green, Yellow and White,\r\nSize: 12 x 12 inches,\r\nMade by: TLE Students of CHMSC Talisay',	'111',	100,	80,	10,	'5a0b2dce9b948aa5dbf947233a240f56.JPG',	9,	2,	1,	'2017-01-22',	1),
...
(69,	'CHMSC Wallet',	'Made of Canvas, Color: Green, Size: 4 x 6 inches',	'110',	35,	30,	10,	'7e9c12bddee1526df3832918a641cc3d.JPG',	9,	0,	1,	'2017-01-23',	1),
...
CREATE TABLE `reservation_item` (
  ...
  CONSTRAINT `reservation_item_ibfk_1` FOREIGN KEY (`reservation_id`) REFERENCES `reservation` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(7,	2,	'juan@gmail.com',	'juan',	'ba8a48b0e34226a2992d871c65600a7c',	'Juan',	'2017-01-06',	1);
